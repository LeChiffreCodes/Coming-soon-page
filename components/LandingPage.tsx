      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#242424] text-[rgba(255,255,255,0.87)] text-center p-6 sm:p-8">
        ...
        <div className="flex gap-6">
          <a
            ...
            className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-[#5865F2] rounded-full hover:bg-[#4752C4] transition-colors shadow-lg"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-black rounded-full hover:bg-gray-800 transition-colors shadow-lg"
          >
            <svg className="w-6 h-6 sm:w-7 sm:h-7 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
